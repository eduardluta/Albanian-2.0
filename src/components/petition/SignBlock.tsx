...
export default function SignBlock() {
  return (
    <section
      id="sign"
      className="py-16 md:py-20 border-t border-rule bg-black"
    >
      <div className="wrap">
        <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-10 lg:gap-12 items-start">
          <div>
            ...
            <p className="text-[16px] sm:text-[17px] text-grey-6 leading-[1.5] max-w-[520px] mb-7">
              One signature is anecdote. 1,000 is a tweet.{" "}
              <strong className="text-paper font-bold">
                100,000 is a problem Netflix has to put on the localization roadmap.
              </strong>{" "}
              That&apos;s our target.
            </p>
            ...
            >
              ...
              <div>
                ...
                <div className="text-[12px] text-grey-6 leading-[1.5]">
                  ...
                  We never see your password — change.org handles delivery to Netflix.
                </div>
              </div>
            </div>
          </div>
