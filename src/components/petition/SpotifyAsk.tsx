export default function SpotifyAsk({ locale }: { locale: string }) {
  return (
    <section className="py-14" style={{ background: "#00C46A", color: "#0a0a0a" }}>
      <div className="wrap grid grid-cols-1 md:grid-cols-[80px_1fr_auto] gap-6 md:gap-9 items-center">
        ...
        <div>
          <div className="text-[11px] tracking-[0.2em] font-bold uppercase mb-3.5 opacity-75">
            Open letter · what we want from Spotify
          </div>
          <h2
            className="font-display tracking-[0.005em] leading-[0.92]"
            style={{ fontSize: "clamp(36px, 5vw, 64px)" }}
          >
            Albanian in the language picker.{" "}
            <em
            ...
            <span>Editorial playlists curated locally.</span>{" "}
            <em
              className="font-serif italic font-normal"
              style={{ letterSpacing: "-0.02em" }}
            >
